                    ...
                    <div class="card card-block card-stretch card-transparent">
                        <div class="card-header d-flex justify-content-between pb-0">
                            <div class="header-title">
                                <h4 v-if="files.length > 0" class="card-title">Search</h4>
                                <h4 v-if="!files.length || files.length < 1" class="card-title">Search list is empty...
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body image-thumb">
                            <div class="mb-4 text-center p-3 rounded iq-thumb">
                                ...
                                <a :href="list.url" target="_blank"><img :src="getPicture(list)"
                                        class="img-cnt img-fluid" :alt="'image' + index"></a>
                            </div>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="text-center" v-else>
                                                                <h6 style="margin-bottom:10px">No any selected folder...
                                                                </h6>
                                                            </div>
                                                            ...
                                                            <div class="text-center" v-else>
                                                                <h6 style="margin-bottom:10px">No any created folder...
                                                                </h6>
                                                            </div>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <div v-if="!list.isEdit">
                                                                <div class="dropdown-item">
                                                                    ...
                                                                    <div @click="getSelectedFolders(list.id)"
                                                            ...
                                                            <hr style="margin-top:0px;margin-bottom:0px"
                                                                v-if="!list.isEdit">
                                                            <div @click="addToFav(list.id)"
                                                                v-if="!list.isEdit && !list.is_fav"
                                                                class="dropdown-item">
                                                                <i class="lar la-star mr-2"></i>like
                                                            </div>
                                                            <div @click="removeFav(list.id)"
                                                                v-if="!list.isEdit && list.is_fav"
                                                                class="dropdown-item">
                                                                <i class="ri-star-fill mr-2"></i>unlike
                                                            </div>
                                                            <div @click="addToTrash(list.id)" v-if="!list.isEdit"
...
export default defineComponent({
    ...
    sortSizeHigh() {
      this.files = this.files.sort((a, b) => {return b.size - a.size;});
        ...
        async sortBySearch(value: string) {
            if (value) {
                this.files = this.tempFiles;
                this.files = this.files.filter(item => {
                    return item.title.toLowerCase().includes(value.toLowerCase());
                });
            } else this.files = this.tempFiles;
