<template>
  <div class="container-fluid">
          ...
          <div class="card card-block card-stretch card-transparent">
            <div class="card-header d-flex justify-content-between pb-0">
              <div class="header-title">
                <h4 v-if="files?.length > 0" class="card-title">Media</h4>
                <h4 v-if="files?.length < 1" class="card-title">No any media...</h4>
              </div>
            </div>
          </div>
    ...
    <div v-if="data" class="icon icon-grid i-grid">
      <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-6" v-for="(list, index) in files" :key="index">
          <div class="card card-block card-stretch card-height">
            <div class="card-body image-thumb">
              <div class="mb-4 text-center p-3 rounded iq-thumb">
                <div class="iq-image-overlay"></div>
                <video :src="list.url" controls poster="@/assets/vido-back.jpg" class="img-cnt img-fluid" alt="video"></video>
                <!-- <a :href="list.url" target="_blank"><img :src="list.url" class="img-cnt img-fluid" alt="image1"></a> -->
              </div>
              <a :href="list.url" target="_blank"><h6 :title="list.title" class="file-title">{{ list.title }}</h6></a>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <tr v-for="(list, index) in files" :key="index">
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="mr-3">
                            <a :href="list.url" target="_blank"><img src="@/assets/ext/mp4.png" class="img-fluid avatar-30"
                                :alt="`image` + index" /></a>
                          </div>
