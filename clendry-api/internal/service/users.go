...
func NewUsersService(repoUsers repository.Users, repoFiles repository.Files, files files.Files,

//repoBlocks repository.BlockRequests, repoFriends repository.FriendRequests,
) *UsersService {
	return &UsersService{
		repoUsers: repoUsers,
